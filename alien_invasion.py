...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        #加载不死图腾图片
        try:
            self.totem_image = pygame.image.load('images/nodind_modified.png')
    ...
    def _update_screen(self):
        ...
        # 如果显示统计界面，只绘制统计界面
            ...
            version_rect.bottomleft = (20, self.settings.screen_height - 10)
    ...
    def _initialize_image_cache(self):
        ...
        # 预加载外星人图像
        alien_images = {
            'alien': 'images/alien_2.bmp',  # 使用 alien_2.bmp 作为默认外星人图像
            'alien_2': 'images/alien_2.bmp',  # 爆炸型
            'alien_3': 'images/alien_3.bmp',  # 快速型
            'alien_4': 'images/alien_4.bmp',  # 坦克型
            'alien_5': 'images/alien_5.bmp',  # 治疗型
            'alien_6': 'images/alien_6.bmp',  # 分裂型
            'alien_7': 'images/alien_7.bmp',  # 隐形型
            'alien_8': 'images/alien_8.bmp',  # 传送型
        }
        ...
        # 预加载飞船皮肤
        for i in range(1, 21):
            ship_images[f'ship_{i}'] = f'images/ship_{i}.bmp'
        ...
        other_images = {
            ...
            'nodind_modified': 'images/nodind_modified.png',
        }
