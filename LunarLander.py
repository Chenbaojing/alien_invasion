...
screen.fill([0, 0, 0])
ship = pygame.image.load("images/lunarlander.png")
moon = pygame.image.load("images/moonsurface.png")
...
def calculate_velocity():
    global thrust, fuel, velocity, delta_v, height, y_pos, ship_mass, myThrottle, fps
    delta_t = 1/fps
...
def display_stats():
    global velocity, height, thrust, delta_v, fps, fuel, screen
