...
class Alien(Sprite):
    ...
    def _load_alien_image(self):
        ...
        if self.image is None:
            if self.is_explosive:
                self.image = pygame.image.load('alien_2.bmp')
            else:
                if self.alien_type == 'normal':
                    self.image = pygame.image.load('alien.bmp')
                elif self.alien_type == 'fast':
                    self.image = pygame.image.load('alien_3.bmp')
                elif self.alien_type == 'tank':
                    self.image = pygame.image.load('alien_4.bmp')
                elif self.alien_type == 'healer':
                    self.image = pygame.image.load('alien_5.bmp')
                elif self.alien_type == 'splitter':
                    self.image = pygame.image.load('alien_6.bmp')
                elif self.alien_type == 'stealth':
                    try:
                        self.image = pygame.image.load('alien_7.bmp')
                    except:
                    ...
                    try:
                        self.image = pygame.image.load('alien_8.bmp')
                    except:
                        self.image = pygame.Surface((50, 50))
                        self.image.fill(self.color)
