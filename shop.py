...
class Shop:
    ...
    def __init__(self, ai_game):
        ...
        # 商店物品数据
        self.skins = [
            {"id": "default", "name": "默认皮肤", "price": 0, "image": "ship.bmp", "owned": True},
            {"id": "ship_1", "name": "皮肤1", "price": 5, "image": "ship_1.bmp", "owned": False},
            {"id": "ship_2", "name": "皮肤2", "price": 5, "image": "ship_2.bmp", "owned": False},
            {"id": "ship_3", "name": "皮肤3", "price": 5, "image": "ship_3.png", "owned": False},
            {"id": "ship_4", "name": "皮肤4", "price": 5, "image": "ship_4.bmp", "owned": False},
            {"id": "ship_5", "name": "皮肤5", "price": 5, "image": "ship_5.bmp", "owned": False},
            {"id": "ship_6", "name": "皮肤6", "price": 10, "image": "ship_6.bmp", "owned": False},
            {"id": "ship_7", "name": "皮肤7", "price": 10, "image": "ship_7.bmp", "owned": False},
            {"id": "ship_8", "name": "皮肤8", "price": 10, "image": "ship_8.bmp", "owned": False},
            {"id": "ship_9", "name": "皮肤9", "price": 10, "image": "ship_9.bmp", "owned": False},
            {"id": "ship_10", "name": "皮肤10", "price": 15, "image": "ship_10.bmp", "owned": False},
            {"id": "ship_11", "name": "皮肤11", "price": 15, "image": "ship_11.bmp", "owned": False},
            {"id": "ship_12", "name": "皮肤12", "price": 15, "image": "ship_12.bmp", "owned": False},
            {"id": "ship_13", "name": "皮肤13", "price": 20, "image": "ship_13.bmp", "owned": False},
            {"id": "ship_14", "name": "皮肤14", "price": 20, "image": "ship_14.bmp", "owned": False},
            {"id": "ship_15", "name": "皮肤15", "price": 20, "image": "ship_15.bmp", "owned": False},
            {"id": "ship_16", "name": "皮肤16", "price": 25, "image": "ship_16.bmp", "owned": False},
            {"id": "ship_17", "name": "皮肤17", "price": 25, "image": "ship_17.bmp", "owned": False},
            {"id": "ship_18", "name": "皮肤18", "price": 25, "image": "ship_18.bmp", "owned": False},
            {"id": "ship_19", "name": "皮肤19", "price": 30, "image": "ship_19.bmp", "owned": False},
            {"id": "ship_20", "name": "皮肤20", "price": 30, "image": "ship_20.bmp", "owned": False},
        ]
    ...
    def _load_purchased_items(self):
        """加载已购买的物品"""
        try:
            with open('purchased_items.json', 'r') as f:
                data = json.load(f)
    ...
    def _load_current_skin(self):
        """加载当前使用的皮肤"""
        try:
            with open('current_skin.json', 'r') as f:
                data = json.load(f)
    ...
    def _save_current_skin(self):
        """保存当前使用的皮肤"""
        with open('current_skin.json', 'w') as f:
